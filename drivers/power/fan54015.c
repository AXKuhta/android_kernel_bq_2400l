...
static void fan54015_vbus_det_work(struct work_struct *work)
{
	...
	if (vbus_gpio) {
		...
		if ((!vbus_gpio_value) && (otg_enable_flag == 1)) {
			...
			fan54015_set_value(FAN5405_REG_OREG, FAN5405_OTG_EN,
					   FAN5405_OTG_EN_SHIFT, 0);
			fan54015_set_value(FAN5405_REG_OREG, FAN5405_OTG_EN,
					   FAN5405_OTG_EN_SHIFT, 1);
			fan54015_set_value(FAN5405_REG_CONTROL1,
				FAN5405_OPA_MODE, FAN5405_OPA_MODE_SHIFT, 1);
		}
...
void fan54015_otg_enable(int enable)
{
	...
	fan54015_set_value(FAN5405_REG_CONTROL1, FAN5405_OPA_MODE,
			   FAN5405_OPA_MODE_SHIFT, enable);

	if (enable) {
		otg_enable_flag = 1;
		SPRD_EX_DEBUG("enable_otg_enable_flag\n");
		fan54015_set_value(FAN5405_REG_OREG, FAN5405_OTG_EN,
				   FAN5405_OTG_EN_SHIFT, enable);
		...
		otg_enable_flag = 0;
		SPRD_EX_DEBUG("disable_otg_disable_flag\n");
