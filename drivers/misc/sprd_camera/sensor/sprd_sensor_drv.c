...
int sprd_sensor_get_sensorid0(int sensor_id)
{
	int ret = 0;
	struct sprd_sensor_dev_info_tag *p_dev;
	int id0_gpio_id = 0;
	...
	id0_gpio_id = p_dev->gpio_tab[SPRD_SENSOR_ID0_GPIO_TAG_E];
	if (gpio_is_valid(id0_gpio_id)) {
		struct device *dev = &p_dev->i2c_info->dev;

		ret = devm_gpio_request(dev, id0_gpio_id,
			sprd_sensor_gpio_names[SPRD_SENSOR_ID0_GPIO_TAG_E]);
		ret = gpio_direction_input(id0_gpio_id);
		value = gpio_get_value(id0_gpio_id);
		printk("sprd_sensor_get_sensorid0 = %d\n",id0_gpio_id);
		printk("sensor %d get  id0 value  %d\n", sensor_id, value);
		devm_gpio_free(dev, id0_gpio_id);
	}
...
int sprd_sensor_get_sensorid1(int sensor_id)
{
	int ret = 0;
	struct sprd_sensor_dev_info_tag *p_dev;
	int id1_gpio_id = 0;
	...
	id1_gpio_id = p_dev->gpio_tab[SPRD_SENSOR_ID1_GPIO_TAG_E];
	if (gpio_is_valid(id1_gpio_id)) {
		struct device *dev = &p_dev->i2c_info->dev;

		ret = devm_gpio_request(dev, id1_gpio_id,
			sprd_sensor_gpio_names[SPRD_SENSOR_ID1_GPIO_TAG_E]);
		ret = gpio_direction_input(id1_gpio_id);
		value = gpio_get_value(id1_gpio_id);
		printk("sprd_sensor_get_sensorid1 = %d\n",id1_gpio_id);
		printk("sensor %d get  id1 value  %d\n", sensor_id, value);
		devm_gpio_free(dev, id1_gpio_id);
	}

	return  value > 0;
}

int sprd_sensor_get_sensorid2(int sensor_id)
{
	int ret = 0;
	struct sprd_sensor_dev_info_tag *p_dev;
	int id2_gpio_id = 0;
	...
	id2_gpio_id = p_dev->gpio_tab[SPRD_SENSOR_ID2_GPIO_TAG_E];
	if (gpio_is_valid(id2_gpio_id)) {
		struct device *dev = &p_dev->i2c_info->dev;

		ret = devm_gpio_request(dev, id2_gpio_id,
			sprd_sensor_gpio_names[SPRD_SENSOR_ID2_GPIO_TAG_E]);
		ret = gpio_direction_input(id2_gpio_id);
		value = gpio_get_value(id2_gpio_id);
		printk("sprd_sensor_get_sensorid2 = %d\n",id2_gpio_id);
		printk("sensor %d get  id2 value  %d\n", sensor_id, value);
		devm_gpio_free(dev, id2_gpio_id);
	}
