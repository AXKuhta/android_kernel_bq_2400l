...
/* task prio */
#define SDIO_TX_TASK_PRIO 90
#define SDIO_RX_TASK_PRIO 89

/* each pac data max size */
#define MAX_PAC_SIZE (2 << 10)
/* pub header size */
...
/* for rx buf */
#define SDIOHAL_RX_RECVBUF_NUM 25
#define SDIOHAL_RX_RECVBUF_LEN (12 << 10)
#define SDIOHAL_RX_NODE_NUM (12 << 10)

#define SDIOHAL_FRAG_PAGE_MAX_ORDER \
		get_order(SDIOHAL_RX_RECVBUF_NUM * SDIOHAL_RX_RECVBUF_LEN)
...
#define SDIOHAL_TX_SENDBUF_LEN (32 * MAX_PAC_SIZE)
...
#define SDIOHAL_ALIGN_512BYTE(a)  (((a)+511)&(~511))
