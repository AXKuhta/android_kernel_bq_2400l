...
static int zram_add(void)
{
	...
	// This is used for swap prioritization
	// ZRAM and other RAM-based devices will be considered fast and preferred first
	// We can safely disable this because we will never have more than one swap device
	...
	// COMMENTED CODE COMMENTED CODE COMMENTED CODE
	// No idea what this one was meant to do
