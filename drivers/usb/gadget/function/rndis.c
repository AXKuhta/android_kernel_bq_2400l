...
void rndis_add_hdr(struct sk_buff *skb)
{
	...
	hdr.MessageType = cpu_to_le32(RNDIS_MSG_PACKET);
	hdr.MessageLength = cpu_to_le32(skb->len);
	hdr.DataOffset = cpu_to_le32(36+pad_len);
	hdr.DataLength = cpu_to_le32(skb->len - sizeof(*header) - pad_len);
