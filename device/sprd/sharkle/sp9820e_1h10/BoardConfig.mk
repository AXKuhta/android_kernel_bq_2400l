...
#only for bringup
#TARGET_BOARD_SHARKLE_BRINGUP := flase
...
#camera dual sensor
#TARGET_BOARD_CAMERA_DUAL_SENSOR_MODULE := flase
...
#set camera minimum dynamic recording frame rate
CONFIG_MIN_CAMRECORDER_FPS := 5

#set camera minimum dynamic recording frame rate
CONFIG_MAX_CAMRECORDER_FPS := 25

#PDAF feature
#TARGET_BOARD_CAMERA_PDAF_TYPE := 0
#TARGET_BOARD_CAMERA_DCAM_PDAF := flase
...
#flash IC
#TARGET_BOARD_CAMERA_FLASH_TYPE :=
...
#3dnr capture
#TARGET_BOARD_CAMERA_3DNR_CAPTURE := flase
...
#dual camera 3A sync
#TARGET_BOARD_CONFIG_CAMERA_DUAL_SYNC := flase
...
#add native mmi test preview size
TARGET_BOARD_CAMERA_MMITEST_PREVIEWSIZE :=320X240
