...
UBOOT_TARGET_DTB := sp9820e_1h10_kaios
PRODUCT_NAME := sp9820e_1h10_k_4m_native
PRODUCT_DEVICE := sp9820e_1h10
PRODUCT_BRAND := SPRD
PRODUCT_MODEL := sp9820e_1h10_k_4m
PRODUCT_WIFI_DEVICE := sprd
PRODUCT_MANUFACTURER := SPRD

#DTS
TARGET_DTB := sp9820e-1h10-kaios-native
BOARD_FEATUREPHONE_CONFIG := true
BOARD_KAIOS_CONFIG := true
BOARD_TEE_CONFIG := trusty
include $(PLATCOMM)/security_feature.mk
PRODUCT_COPY_FILES += \
    $(BOARDDIR)/sp9820e_1h10_k_4m.xml:$(PRODUCT_OUT)/sp9820e_1h10.xml
