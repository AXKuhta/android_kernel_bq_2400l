...
#define agcp_ahb_reg_set(reg, bit) \
	regmap_update_bits(agcp_ahb_gpr, (reg), (bit), (bit))
#define agcp_ahb_reg_clr(reg, bit) \
	regmap_update_bits(agcp_ahb_gpr, (reg), (bit), (0))
#define agcp_ahb_reg_hw_set(reg, bit) \
	regmap_hwlock_update_bits(agcp_ahb_gpr, (reg), (bit), (bit))
#define agcp_ahb_reg_hw_clr(reg, bit) \
	regmap_hwlock_update_bits(agcp_ahb_gpr, (reg), (bit), (0))
