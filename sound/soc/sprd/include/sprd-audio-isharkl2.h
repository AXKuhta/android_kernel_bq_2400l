...
#ifndef __SPRD_AUDIO_ISHARKL2_H
#define __SPRD_AUDIO_ISHARKL2_H
...
#define DMA_REQ_ARM7_VBC_AD0            (0 + 1)
#define DMA_REQ_ARM7_VBC_AD1            (1 + 1)
#define DMA_REQ_ARM7_VBC_AD2            (2 + 1)
#define DMA_REQ_ARM7_VBC_AD3            (3 + 1)
...
#define DMA_REQ_AP_VBDA0                   (40 + 1)
#define DMA_REQ_AP_VBDA1                   (41 + 1)
#define DMA_REQ_AP_VBAD0                   (44 + 1)
#define DMA_REQ_AP_VBAD1                   (45 + 1)
#define DMA_REQ_AP_VBAD2                   (46 + 1)
#define DMA_REQ_AP_VBAD3                   (47 + 1)
#define DMA_REQ_AP_VBDA2                   (42 + 1)
#define DMA_REQ_AP_VBDA3                   (43 + 1)
...
static inline int _arch_audio_vbc_reset(void)
{
	...
	aon_apb_reg_set(REG_AON_APB_VBC_CTRL, BIT_AON_APB_VBC_SOFT_RST);
	udelay(10);
	aon_apb_reg_clr(REG_AON_APB_VBC_CTRL, BIT_AON_APB_VBC_SOFT_RST);
...
{
	pr_debug("isharkL2 do not need xtlbuf g_clk's addr %p",
		g_clk_status_addr);
}
...
static inline void _vbc_eb_set(void)
{
	...
	uint32_t val = 0;
		...
		while (1) {
			ret = aud_aon_bit_raw_set(REG_AON_APB_VBC_CTRL,
			BIT_AON_APB_VBC_EB);
			if (ret == 0) {
				ret = aon_apb_reg_read(REG_AON_APB_VBC_CTRL,
						       &val);
...
{
	aud_aon_bit_raw_clear(REG_AON_APB_VBC_CTRL, BIT_AON_APB_VBC_EB);
}
...
static inline int arch_audio_vbc_reg_enable(void)
{
	...
	aon_apb_gpr_null_check();
	aon_apb_reg_set(REG_AON_APB_VBC_CTRL, BIT_AON_APB_VBC_EB);
	return ret;
}
...
static inline int arch_audio_vbc_reg_disable(void)
{
	...
	aon_apb_gpr_null_check();
	aon_apb_reg_clr(REG_AON_APB_VBC_CTRL, BIT_AON_APB_VBC_EB);
	return ret;
}
...

{
	int ret = 0;
	int val = 0;
	int mask = BIT_AON_APB_VBC_DAC01_DMA_SYS_SEL(3) |
		BIT_AON_APB_VBC_DAC23_DMA_SYS_SEL(3) |
		BIT_AON_APB_VBC_ADC01_DMA_SYS_SEL(3) |
		BIT_AON_APB_VBC_ADC23_DMA_SYS_SEL(3);
	...
	case VBC_DMA_TO_AP_AON_CTRL:
		...
		val |=
		    (vbc_use_dma_type[0] ==
		     0) ? BIT_AON_APB_VBC_DAC01_DMA_SYS_SEL(2) :
		    BIT_AON_APB_VBC_DAC01_DMA_SYS_SEL(0);
		val |=
		    (vbc_use_dma_type[1] ==
		     0) ? BIT_AON_APB_VBC_DAC23_DMA_SYS_SEL(2) :
		    BIT_AON_APB_VBC_DAC23_DMA_SYS_SEL(0);
		val |=
		    (vbc_use_dma_type[2] ==
		     0) ? BIT_AON_APB_VBC_ADC01_DMA_SYS_SEL(2) :
		    BIT_AON_APB_VBC_ADC01_DMA_SYS_SEL(0);
		val |=
		    (vbc_use_dma_type[3] ==
		     0) ? BIT_AON_APB_VBC_ADC23_DMA_SYS_SEL(2) :
		    BIT_AON_APB_VBC_ADC23_DMA_SYS_SEL(0);
		aon_apb_reg_update(REG_AON_APB_VBC_CTRL, mask, val);

		break;
	case VBC_DMA_TO_WTLCP_TGDSP_CTRL:
		val = BIT_AON_APB_VBC_DAC01_DMA_SYS_SEL(1) |
			BIT_AON_APB_VBC_DAC23_DMA_SYS_SEL(1) |
			BIT_AON_APB_VBC_ADC01_DMA_SYS_SEL(1) |
			BIT_AON_APB_VBC_ADC23_DMA_SYS_SEL(1);
...
static inline int arch_audio_vbc_int_switch(int master)
{
	int ret = 0;
	int val = 0;
	int mask = BIT_AON_APB_VBC_DAC01_INT_SYS_SEL(3) |
	BIT_AON_APB_VBC_DAC23_INT_SYS_SEL(3) |
	BIT_AON_APB_VBC_ADC01_INT_SYS_SEL(3) |
	BIT_AON_APB_VBC_ADC23_INT_SYS_SEL(3);
	aon_apb_gpr_null_check();

	switch (master) {
	case VBC_INT_TO_AP_CTRL:
		val = BIT_AON_APB_VBC_DAC01_INT_SYS_SEL(0) |
			BIT_AON_APB_VBC_DAC23_INT_SYS_SEL(0) |
			BIT_AON_APB_VBC_ADC01_INT_SYS_SEL(0) |
			BIT_AON_APB_VBC_ADC23_INT_SYS_SEL(0);
		aon_apb_reg_update(REG_AON_APB_VBC_CTRL, mask, val);
		break;

	case VBC_INT_TO_WTLCP_CTRL:
		val = BIT_AON_APB_VBC_DAC01_INT_SYS_SEL(1) |
			BIT_AON_APB_VBC_DAC23_INT_SYS_SEL(1) |
			BIT_AON_APB_VBC_ADC01_INT_SYS_SEL(1) |
			BIT_AON_APB_VBC_ADC23_INT_SYS_SEL(1);
		aon_apb_reg_update(REG_AON_APB_VBC_CTRL, mask, val);
		break;

	case VBC_INT_TO_PUBCP_CTRL:
		val = BIT_AON_APB_VBC_DAC01_INT_SYS_SEL(2) |
			BIT_AON_APB_VBC_DAC23_INT_SYS_SEL(2) |
			BIT_AON_APB_VBC_ADC01_INT_SYS_SEL(2) |
			BIT_AON_APB_VBC_ADC23_INT_SYS_SEL(2);
		aon_apb_reg_update(REG_AON_APB_VBC_CTRL, mask, val);
...
static inline int arch_audio_codec_digital_reg_enable(void)
{
	...
	aon_apb_gpr_null_check();
	ret = aon_apb_reg_set(REG_AON_APB_VBC_CTRL, BIT_AON_APB_AUD_EB);
	if (ret >= 0)
...
static inline int arch_audio_codec_digital_reg_disable(void)
{
	...
	aon_apb_reg_clr(REG_AON_APB_VBC_CTRL, BIT_AON_APB_AUD_EB);
...
static inline int arch_audio_codec_digital_enable(void)
{
	...
	ret = anlg_phy_g_reg_set(REG_ANLG_PHY_G2_ANALOG_BB_TOP_CLK_CFG_0,
		BIT_ANLG_PHY_G2_ANALOG_BB_TOP_SINDRV_ENA);
	if (ret != 0)
...
static inline int arch_audio_codec_digital_disable(void)
{
	...
	ret = anlg_phy_g_reg_clr(REG_ANLG_PHY_G2_ANALOG_BB_TOP_CLK_CFG_0,
		BIT_ANLG_PHY_G2_ANALOG_BB_TOP_SINDRV_ENA);
...
static inline int arch_audio_codec_digital_reset(void)
{
	...
	aon_apb_gpr_null_check();
	aon_apb_reg_set(REG_AON_APB_VBC_CTRL, BIT_AON_APB_AUD_SOFT_RST);
	aon_apb_reg_set(REG_AON_APB_VBC_CTRL, BIT_AON_APB_AUDIF_SOFT_RST);

	udelay(10);
	aon_apb_reg_clr(REG_AON_APB_VBC_CTRL, BIT_AON_APB_AUD_SOFT_RST);
	aon_apb_reg_clr(REG_AON_APB_VBC_CTRL, BIT_AON_APB_AUDIF_SOFT_RST);
...
static inline int arch_audio_sleep_xtl_enable(void)
{
	...
	pmu_apb_reg_set(REG_PMU_APB_SLEEP_XTL_ON_CTRL0,
		BIT_PMU_APB_AP_SYS_SLEEP_XTL_ON);
...
{
	pmu_apb_gpr_null_check();
	pmu_apb_reg_clr(REG_PMU_APB_SLEEP_XTL_ON_CTRL0,
		BIT_PMU_APB_AP_SYS_SLEEP_XTL_ON);
...
{
	pmu_com_apb_gpr_null_check();
	if (enable == true)
		pmu_com_apb_reg_clr(REG_COM_PMU_APB_AUD_DMA_BUSY_SLP_EN,
			BIT_COM_PMU_APB_DMA_MASTER_PUB0_FRC_LSLP);
	else
		pmu_com_apb_reg_set(REG_COM_PMU_APB_AUD_DMA_BUSY_SLP_EN,
			BIT_COM_PMU_APB_DMA_MASTER_PUB0_FRC_LSLP);

	return 0;
}
#endif /* __SPRD_AUDIO_ISHARKL2_H */
